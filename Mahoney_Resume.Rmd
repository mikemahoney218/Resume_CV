...
Wayfair_Analyst_June19$Bullets <- c(
  "Develop and launch department's first automated streaming data pipelines, connecting BuildKite, Docker, R, Python and T-SQL in order to create always-up real-time dashboards.",
  ...
  "Serve as department subject-matter expert on technical matters (including R, SQL, Git, and Docker")
...
make_detailed_section(OtherAccomplishments,
                      TechnicalSkills)
```
