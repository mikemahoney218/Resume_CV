...
tribble(
  ~ When, ~ BeforeYou, ~ You, ~ AfterYou, ~ Title, ~ Details, ~ url,
  "2023", "Johnson, L.K.,", "Mahoney, M. J.,", "and Beier, C. M.", "Bridging the Gap Between Pixels and Minimum Estimation Units: Small-Area Uncertainty Estimation with Forest Aboveground Biomass Maps.", "American Geophysical Union Fall Meeting, San Francisco, CA", "",
