...
tribble(
  ...
  "2021", "", "Mahoney, M. J.,", "Beier, C. M., and Ackerman, A. C. In Review.", "Interactive 3D visualizations of geospatial data using the terrainr R package.", "In review at IEEE Computer Graphics and Applications", ""
) %>% 
