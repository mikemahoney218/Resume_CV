...
tribble(
  ...
  "2022", "Johnson, L. K.,", "Mahoney, M. J.,", "Bevilacqua, E., Stehman, S. V., Domke, G. M., and Beier, C. M. In Review.", "High-resolution landscape-scale biomass mapping using a spatiotemporal patchwork of LiDAR coverages", "In review at Environmental Research Letters", "https://doi.org/10.48550/arXiv.2205.08530",
  "2022", "", "Mahoney, M. J.,", "Johnson, J. K., and Beier, C. M. In Review.", "Classification and mapping of low-statured 'shrubland' cover types in post-agricultural landscapes of the US Northeast.", "In review at Landscape Ecology", "https://doi.org/10.48550/arXiv.2205.05047",
  "2022", "", "Mahoney, M. J.,", "Johnson, J. K., Bevilacqua, E., and Beier, C. M. In Review.", "Ground noise filtering produces inferior models of forest aboveground biomass.", "In review at GIScience and Remote Sensing", "https://doi.org/10.31223/X5HG99"
...
tribble(
  ~ When, ~ BeforeYou, ~ You, ~ AfterYou, ~ Title, ~ Details, ~ url,
  "2022", "Sun, Z., and,", "Mahoney, M. J.", "", "AI for All People: How to Make AI Useful for Earth Science Applications?", "Session organized at the Federation of Earth Science Information Partners (ESIP) July Meeting, Pittsburgh, PA", "",
...
tribble(
  ~ When, ~ Title, ~ Details, ~ url,
  "2022", "Reviewer:", "11th International Conference on Climate Informatics.", "",
...
tribble(
  ...
  "Intern with RStudio's tidymodels team, working on the spatialsample R package for spatial data resampling."
) %>% 
...
tribble(
  ...
  "spatialsample", "2022", "Developer", "Functions for spatial resampling with the 'rsample' package", 
